...
@Entity()
export class IbCommissionDeals {
  @PrimaryGeneratedColumn({ name: 'ID' })
  id: number

  @Column({ type: 'float', name: 'Commission', nullable: true })
  commission: number

  @Index('IDX_ib_commission_deals_Login')
  @ManyToOne(() => Mt5Account, (mt5Account) => mt5Account.deals)
  @JoinColumn({ name: 'Login', referencedColumnName: 'login' })
  login: Mt5Account

  @Index('IDX_ib_commission_deals_Client')
  @ManyToOne(() => Client, (client) => client.ibCommissionDeals)
  @JoinColumn({ name: 'ClientId' })
  client: Client

  @Index('IDX_ib_commission_deals_Partner')
  @ManyToOne(() => Partner, (partner) => partner.ibCommissionDeals)
  @JoinColumn({ name: 'PartnerId' })
  partner: Partner

  @Index('IDX_ib_commission_deals_ParentDealId')
  @ManyToOne(() => IbCommissionDeals, (deal) => deal.id, { nullable: true })
  @JoinColumn({ name: 'ParentDealId' })
  parentDeal: IbCommissionDeals

  @Index('IDX_ib_commission_deals_ParentDealId')
  @Column({ name: 'ParentDealId', nullable: true })
  parentDealId: number

  @Index('PK_ib_commission_deals_deal', { unique: true })
  @Column({
    name: 'Deal',
    type: 'decimal',
    precision: 20,
  ...
  @Index('IDX_ib_commission_deals_Timestamp')
